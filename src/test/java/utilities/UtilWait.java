...
public class UtilWait {
    ...
    public static WebElement waitUntilElementClickable(WebDriver driver, int totalWaitTime, int pollingTime, By locator){
        Wait<WebDriver> wait=new FluentWait<>(driver).withTimeout(Duration.ofSeconds(totalWaitTime))
